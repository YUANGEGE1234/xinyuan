...
Xinyuan assembles these payloads from JSON round-trips, so they are already wire
...
def bypass_chat_sdk_request_transform(request_kwargs: dict, client: Any) -> dict:
    ...
    afterwards. Xinyuan also drives chat-shaped facades that are NOT the SDK (the
