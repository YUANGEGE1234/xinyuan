"""Upload a Xinyuan session transcript to Hugging Face as an agent trace, re-emitted in the **Claude Code
...
# --- Conversion: Xinyuan OpenAI-format messages -> Claude Code JSONL ---
