...
def openclaw_residue_hint_cli() -> str:
    """Banner shown the first time Xinyuan finds ``~/.openclaw/``: migrate first, cleanup (which breaks OpenClaw) after."""
    return (
        "A legacy OpenClaw directory was detected at ~/.openclaw/.\n"
        "To port your config, memory, and skills over to Xinyuan, run `hermes claw migrate`.\n"
