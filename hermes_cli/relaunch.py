"""Unified self-relaunch for Xinyuan CLI: preserves inherited flags (--tui, --dev, --profile, --model…)
...
def resolve_hermes_bin() -> Optional[str]:
    """Xinyuan entry point: ``sys.argv[0]`` if a real executable, else ``which hermes``, else ``None``
