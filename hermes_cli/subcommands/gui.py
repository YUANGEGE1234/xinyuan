...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Xinyuan Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        "--hermes-root",
        help="Override the Xinyuan source root used by Desktop (sets HERMES_DESKTOP_HERMES_ROOT)")
    gui_parser.add_argument(
        "--cwd",
    ...
    gui_parser.add_argument(
        "--identity", default="Xinyuan Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Xinyuan Local Signing)",
    )
