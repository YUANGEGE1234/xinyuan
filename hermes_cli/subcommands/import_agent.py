...
def build_import_agent_parser(subparsers, *, cmd_import_agent: Callable) -> None:
    ...
    parser = subparsers.add_parser(
        "import-agent", help="Import a Claude Code or Codex CLI setup into Xinyuan",
        description="One-command import of another coding agent's setup into Xinyuan. "
            "Maps CLAUDE.md/AGENTS.md instructions, permission allowlists, MCP "
            "servers, skills, and memories into their Xinyuan equivalents. "
    ...
    parser.add_argument(
        ...
        help="Overwrite existing Xinyuan items on name conflicts (default: skip)")
