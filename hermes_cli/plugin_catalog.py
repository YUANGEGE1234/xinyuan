"""Plugin catalog — curated, Nous-approved Xinyuan plugins shipped with the repo.
...
an installed Xinyuan sees new entries and removals without updating. Any fetch failure falls back to the
