"""Slash command registry for the Xinyuan CLI and gateway.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of Xinyuan config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal Xinyuan works on across turns until achieved", "Session",
    ...
    CommandDef("wake", "Toggle the 'Hey Xinyuan' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]", subcommands=("on", "off", "status")),
    CommandDef("busy", "Control how messages behave while Xinyuan is working", "Configuration",
    ...
    CommandDef("update", "Update Xinyuan Agent to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Xinyuan Agent version", "Info", aliases=("v",),
