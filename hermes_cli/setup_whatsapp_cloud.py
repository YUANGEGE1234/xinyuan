...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Xinyuan to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Xinyuan needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Xinyuan gateway in another terminal:",
        "         hermes gateway", "",
