"""Unified tool configuration for Xinyuan Agent."""
...
TOOL_CATEGORIES = {
    ...
    "x_search": {
        ...
        "setup_note": (
            "Xinyuan routes X searches through xAI's built-in x_search Responses tool for read-only public X "
    ...
    "browser": {
        ...
        "providers": [
            ...
            _row("Lightpanda", "free · local · no Chromium", "Zig headless browser spawned by Xinyuan, text-only (no screenshots)",
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    ...
    if getattr(args, "summary", False):
        ...
        return
    print(color("☤ Xinyuan Tool Configuration", Colors.CYAN, Colors.BOLD))
