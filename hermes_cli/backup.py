...
# Xinyuan-managed runtime downloads (see ``LOCAL_RUNTIME_ROOT_DIRS``). Matched ONLY at the root of
...
def run_backup(args) -> None:
    ...
    if not hermes_root.is_dir():
        print(f"Error: Xinyuan home directory not found at {hermes_root}")
        sys.exit(1)
