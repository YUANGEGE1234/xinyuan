"""Durable aggregation and local export for Xinyuan shared metrics."""
...
class SharedMetricsStore:
    ...
    def _ensure_schema(self) -> None:
        # Serialize first-run creation and upgrades across Xinyuan processes.
        with self._write(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            ...
            # so a bump would hard-fail an older Xinyuan (second profile, rollback) sharing
