"""Single source of truth for provider identity in Xinyuan Agent."""
...
# -- Xinyuan overlay: metadata models.dev doesn't provide ----------------------
...
def _lossy_alias_registry_pdef(raw: str, canonical: str) -> Optional[ProviderDef]:
    """Exact Xinyuan registry ids win over LOSSY alias collapsing (kimi-coding-cn must stay distinct
