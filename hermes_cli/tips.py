...
TIPS = [
    ...
    "Ctrl+Z suspends Xinyuan to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Xinyuan itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Xinyuan home directory.",
    ...
    "hermes gateway install sets up Xinyuan as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Xinyuan tools programmatically — results stay out of context.",
    ...
    "When exiting, Xinyuan prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Xinyuan runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Xinyuan via a local macOS server.",
    ...
    "Xinyuan loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Xinyuan as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Xinyuan your own.",
    ...
    "Before a gateway session reset, Xinyuan auto-flushes important facts to memory in the background.",
    ...
    "Profiles scope Xinyuan state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Xinyuan auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Xinyuan config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Xinyuan is working.',
    ...
    'hermes dashboard embeds the full Xinyuan TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'hermes import restores a full Xinyuan backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Xinyuan block commands when the tirith scanner itself errors out.',
...
# Task-oriented example prompts for the empty composer. Kept generic — Xinyuan is
