...
Xinyuan Agent (see website/docs/getting-started/platform-support.md). The
...
Xinyuan package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    ...
    "Xinyuan is distributed via the shell installer, Docker image, or Nix.\n"
    ...
    "the Xinyuan Nix derivation sets HERMES_NIX_BUILD=1. If it does, file a bug."
)
