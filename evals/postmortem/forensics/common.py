"""Shared loaders for the post-mortem forensics: point at ANY Xinyuan ``state.db`` (a copy, never the live
...
the recomputed dollars match what THAT Xinyuan recorded, not an invoice.
