"""Centralized logging setup for Xinyuan Agent.
...
# in Xinyuan (TUI, gateway, hy_memory, MCP servers, CLI commands all log) —
...
def setup_logging(
    *,
    ...
    """Configure the Xinyuan logging subsystem; returns the ``logs/`` directory.
    ...
    # A second Xinyuan home in a process that already logs for another one — a dashboard or
...
class _ProfileRoutingFileHandler(logging.Handler):
    """Route queued records to the log file for their Xinyuan home.
