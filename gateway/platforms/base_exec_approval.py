...
the same three things: what Xinyuan wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "Xinyuan wants to run a command that needs your OK"
