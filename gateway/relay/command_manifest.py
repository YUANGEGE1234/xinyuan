...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Xinyuan session"),
        ...
        _cmd("status", "Show Xinyuan session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Xinyuan agent"),
        ...
        _cmd("update", "Update Xinyuan Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Xinyuan gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Xinyuan session in it",
