  ...
  const versionSsh = fakeSsh([
    [
      ...
      (cmd: string) => {
        ...
        return 'Xinyuan Agent v0.18.2 (abc123)\n'
      }
    ]
  ])

  assert.equal(await probeHermesVersion(versionSsh, '/x/hermes'), 'Xinyuan Agent v0.18.2 (abc123)')
