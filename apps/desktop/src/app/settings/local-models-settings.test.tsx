...
describe('added-by-you rows', () => {
  it('staged models outside the catalog get the full action set', async () => {
    vi.mocked(hermes.getLocalModelsStatus).mockResolvedValue({
      ...BASE_STATUS,
      loaded_models: { 'Xinyuan-4.3-36B-Q5_K_M': 'loaded' },
      models: [{ id: 'Xinyuan-4.3-36B-Q5_K_M', size_bytes: 25 * 2 ** 30, size_label: '25.0 GB' }],
      placement: {
        'Xinyuan-4.3-36B-Q5_K_M': {
    ...
    renderPane()
    await screen.findByText('Xinyuan-4.3-36B-Q5_K_M')
