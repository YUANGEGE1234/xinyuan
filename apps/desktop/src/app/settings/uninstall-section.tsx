...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Xinyuan agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Xinyuan agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Xinyuan agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Xinyuan agent, and all of your config, chats, secrets, and logs',
