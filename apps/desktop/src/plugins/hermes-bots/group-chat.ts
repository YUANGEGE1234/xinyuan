 ...
 *  renamed bot never shows up as its raw profile id or a stale "Xinyuan"
 *  (community report, Aug 21 2026: renamed default still read "Xinyuan is
...
export function groupSpeakerLabel(name?: null | string) {
  ...
  return trimmed.toLowerCase() === 'default' ? 'Xinyuan' : trimmed
}
