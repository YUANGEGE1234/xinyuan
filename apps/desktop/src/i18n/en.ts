...
export const en: Translations = {
  catalog: {
    ...
    snapshotHint: 'From the Xinyuan catalog. Browsing never contacts source repositories.',
  ...
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Xinyuan to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into Xinyuan and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Xinyuan.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Xinyuan. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Xinyuan',
    continue: 'Continue in Xinyuan',
  ...
  boot: {
    ready: 'Xinyuan Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Xinyuan settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Xinyuan backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Xinyuan Desktop…'
    },
    errors: {
      ...
      backgroundExitedDuringStartup: 'Xinyuan stopped right after it started.',
      backendStopped: 'Xinyuan stopped working in the background',
      restartHermes: 'Restart Xinyuan',
      openLogs: 'Open logs',
      desktopBootFailed: "Xinyuan couldn't start",
      gatewayConnectionLost: 'Xinyuan lost its connection',
      ...
      gatewaySignInRequired: 'Your remote Xinyuan signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "Xinyuan Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "Xinyuan' background service stopped right after starting.",
      timedOut: "Xinyuan' background service didn't answer in time.",
      permission: "Xinyuan couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so Xinyuan could not start.',
      portInUse: 'Another program is using the network port Xinyuan needs.',
      installMissing: "Part of Xinyuan' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "Xinyuan couldn't start",
      description:
        "Xinyuan' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Xinyuan backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Xinyuan',
    ...
    errors: {
      ...
      storageFailure: "Xinyuan couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This Xinyuan no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed: "Xinyuan' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired: 'Xinyuan was updated but is still running the old version. Restart it to finish the update.',
      restartHermesFailed: "Couldn't restart Xinyuan"
    },
    actions: {
      restartHermes: 'Restart Xinyuan',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Xinyuan',
    ...
    native: {
      ...
      inputBody: 'Xinyuan is waiting for your response.',
      turnDoneTitle: 'Xinyuan finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Xinyuan defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Xinyuan catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Xinyuan generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Xinyuan picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Xinyuan.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Xinyuan closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Xinyuan is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Xinyuan asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Xinyuan was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Xinyuan was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Xinyuan follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Xinyuan can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Xinyuan. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Xinyuan spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Xinyuan is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Xinyuan, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallHermes: 'Uninstall Xinyuan'
    },
    poolLimits: {
    ...
    about: {
      heading: 'Xinyuan Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Xinyuan runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Xinyuan only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Xinyuan',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Xinyuan checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Xinyuan configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Xinyuan.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Xinyuan gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Xinyuan Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Xinyuan Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Xinyuan runtime managed by this app.',
      kindRemoteDesc: 'A Xinyuan gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Xinyuan Cloud account.',
      kindSshDesc: 'A Xinyuan install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Xinyuan manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Xinyuan Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc: 'Connection settings can only be changed from the Xinyuan Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a Xinyuan backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Xinyuan was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Xinyuan without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Xinyuan backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Xinyuan backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Xinyuan Cloud',
      cloudDesc: 'Sign in once to Xinyuan Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Xinyuan Cloud',
      cloudSignIn: 'Sign in to Xinyuan Cloud',
      cloudSignedIn: 'Signed in to Xinyuan Cloud',
      cloudNeedsSignIn: 'Sign in to Xinyuan Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Xinyuan Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Xinyuan Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Xinyuan Cloud',
      cloudSignedOutMessage: 'Cleared the Xinyuan Cloud session.',
      ...
      probeError: "Xinyuan can't reach that address. Check the URL and that the other computer is running Xinyuan — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'Xinyuan Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Xinyuan ${version}` : ''}`,
      ...
      sshDesc:
        'Xinyuan is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Xinyuan path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Xinyuan found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Xinyuan runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Xinyuan is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Xinyuan path.',
      sshErrPlatform:
        'Unsupported remote platform. Xinyuan Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Xinyuan on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Xinyuan. Review the exact configuration below — it comes from the link, not from Xinyuan.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Xinyuan starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Xinyuan runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Xinyuan at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Xinyuan can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Xinyuan browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    plugins: {
      ...
      defaultProfile: 'Xinyuan (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Xinyuan to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Xinyuan catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Xinyuan builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Xinyuan to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Xinyuan to generate pets.',
      backgroundHint: 'You can close this — Xinyuan will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Xinyuan desktop' },
    ...
    hermesActiveSessions: (version, count) => `Xinyuan ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "Xinyuan couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Xinyuan installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Xinyuan creates the bot and detects your Telegram user ID automatically.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Xinyuan you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Xinyuan environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Xinyuan did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Xinyuan will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Xinyuan backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Xinyuan. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Xinyuan backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Xinyuan...',
    placeholderReconnecting: 'Reconnecting to Xinyuan…',
    ...
    voiceEngineChained: 'Speech-to-text + Xinyuan voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Xinyuan)',
    ...
    attachUrlDesc: 'Xinyuan will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Xinyuan to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Xinyuan…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Xinyuan…',
    ...
    unsupportedMessage: 'This version of Xinyuan can’t update itself from inside the app.',
    connectionRetry:
      "Xinyuan couldn't reach the update server. Check your internet connection and try again. If you use a remote Xinyuan, make sure it is online.",
    connectionSettings: 'Connection settings',
    ...
    availableBody: 'A new version of Xinyuan is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Xinyuan backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Xinyuan from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Xinyuan will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Xinyuan desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Xinyuan updater takes over in its own window and reopens Xinyuan automatically when it’s done. Please don’t reopen Xinyuan yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Xinyuan reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Xinyuan reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Xinyuan?',
    blockerBody:
      'Xinyuan needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Xinyuan',
    foreignBlockerBody:
      'Xinyuan can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Xinyuan can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Xinyuan is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Xinyuan whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Xinyuan. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Xinyuan needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Xinyuan Desktop',
    setupChoiceDesc:
      'Connect this app to a Xinyuan gateway you already run, or install Xinyuan locally on this computer.',
    connectExistingTitle: 'Connect to existing Xinyuan',
    ...
    installLocalTitle: 'Install Xinyuan locally',
    installLocalDesc: 'Download Xinyuan, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Xinyuan Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Xinyuan',
    remoteSetupDesc: 'Enter your gateway URL. Xinyuan Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Xinyuan gateway, including https:// when remote.',
    ...
    settingUpTitle: 'Setting up Xinyuan',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Xinyuan is running, the internet connection dropped, or antivirus blocked the installer. Close other Xinyuan windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
      'This is a one-time setup. The Xinyuan installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Xinyuan",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Xinyuan is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Xinyuan…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Xinyuan',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Xinyuan at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Xinyuan connects automatically',
    ...
    authorizeThere: 'Authorize Xinyuan there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Xinyuan there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    retiredBody:
      'Your session ended before the sign-in finished. Xinyuan will start a new one; then sign in again whenever you\'re ready.',
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `Xinyuan couldn't finish signing you in because the Nous service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "Xinyuan couldn't reach the Nous service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This Xinyuan is already signed in to a Nous account.',
    setupFailed: {
      gateClosed:
        "This version of Xinyuan can't start without a Nous account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using Xinyuan without signing in is paused for a moment. Xinyuan will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so Xinyuan will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "Xinyuan couldn't reach the Nous service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      ...
      generic: "Xinyuan couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Xinyuan Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Xinyuan Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Xinyuan will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Xinyuan is restarting...',
      askRestart: 'Ask Xinyuan to restart the server',
      lookingRestart: taskId => `Xinyuan is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Xinyuan is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Xinyuan to open a page.',
      finishedRestarting: message => `Xinyuan finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Xinyuan could not restart the server.',
      stillWorking:
        'Xinyuan is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Xinyuan is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'Xinyuan hit a problem',
        generic: "Xinyuan couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Xinyuan hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so Xinyuan could not save this conversation. Free some space, then retry.',
        endpoint: "Xinyuan can't reach your custom model server. Check that it is running, then send your message again.",
        gateway: 'Xinyuan hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while Xinyuan was replying. Retry, or copy the details if it keeps happening.',
        provider: 'The AI service could not complete this request. Retry in a moment or switch provider.',
        runtime: 'Xinyuan hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Xinyuan could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Xinyuan could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Xinyuan got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Xinyuan stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Xinyuan window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Xinyuan could not save this conversation. Free some space, then retry.'
        },
        ...
        free_tier_disabled: {
          title: 'Using Xinyuan without signing in is switched off right now',
        ...
        free_tier_model_not_free: {
          ...
          body: "Xinyuan uses the free model for now. Sign in with a Nous account for more models, it's free."
        },
        free_tier_route: {
          title: "Xinyuan couldn't reach the free model on this route",
        ...
        free_tier_refused: {
          title: "Xinyuan couldn't send that without signing in",
      ...
      errorToastTitle: "Xinyuan couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenHermesFolder: 'Open Xinyuan folder',
      errorOpenHermesFolderFailed: 'Could not open the Xinyuan folder',
    ...
    approval: {
      gatewayDisconnected:
        'Xinyuan is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Xinyuan to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Xinyuan won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'Xinyuan is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'Xinyuan needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Xinyuan reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Xinyuan types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Xinyuan enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Xinyuan Desktop to use Save Image.',
    restartToSaveImages: 'Restart Xinyuan Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: "Xinyuan couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Xinyuan loads when the work calls for them.'
      },
      messaging: {
        title: 'Xinyuan away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Xinyuan made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Xinyuan — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
