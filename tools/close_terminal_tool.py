"""Close a read-only agent terminal tab in the Xinyuan desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the Xinyuan desktop GUI (the tabs mirroring terminal(background=true) runs). "
