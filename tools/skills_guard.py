...
THREAT_PATTERNS = [
    ...
    # quarantine only acts on "dangerous") but high for Xinyuan/other config (setup docs routinely say
...
# `.skillignore` is Xinyuan-native; `.clawhubignore` is honored for skills published through ClawHub.
